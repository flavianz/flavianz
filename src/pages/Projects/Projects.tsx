...
export default function Projects({
    ...
    const projects = [
        ...
        <Item
            ...
            stack={["Java", "JavaFX", "Gradle", "Server - Client Architecture"]}
        />,
        <Item
            title={"Playground"}
            description={
    ...
    const shownProjectCount = Math.max(
        Math.floor((windowSize.width - 350) / 390),
        1,
    );
    return (
        <div className={className + " " + styles.container}>
            ...
            <div className={styles.projects}>
                ...
                {projects.slice(
                    activeProject,
                    activeProject + shownProjectCount,
                )}
                <p id={styles.mobileScrollExtender}>a</p>
                {activeProject < projects.length - shownProjectCount && (
                    <p
                        className={styles.projectSelector}
                        onClick={() => setActiveProject(activeProject + 1)}
                    >
